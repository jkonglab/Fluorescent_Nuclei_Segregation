function  [close_adj_pts,count_adj,conn_lines,Connected_Pts,line_num]=Augment_adj_Close(close_adj_pts,count_adj,list_ind,k,b, Gdir,conn_lines,Connected_Pts,line_num,Nx,Ny,gradDX,gradDY,close_nonadj_pts,count_nonadj)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
